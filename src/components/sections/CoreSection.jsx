      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="hidden lg:block max-w-5xl mx-auto">
          <div className="grid grid-cols-1 grid-rows-1">
            ...
            {/* The 2x2 Puzzle Grid (Bottom Layer) */}
            <div className="grid grid-cols-2 gap-12 col-start-1 row-start-1">
              {coreProducts.map((product, index) => (
                <motion.div
                  ...
                  className="group rounded-3xl p-8 cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-300 h-80 relative overflow-hidden"
            ...
            <div className="col-start-1 row-start-1 flex items-center justify-center pointer-events-none">
              ...
              >
                <div className="w-48 h-48 bg-gradient-to-br from-gray-900 to-gray-800 rounded-full shadow-2xl flex items-center justify-center border-8 border-white cursor-pointer hover:scale-105 transition-transform duration-300 relative overflow-hidden">
                  {/* Pulse effect */}
          ...
          {coreProducts.map((product, index) => {
            ...
            return (
              <motion.div
                ...
                onClick={() => setActiveModal(product.id)}
                className="group rounded-2xl p-6 cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden"
          ...
          >
            <div className="w-48 h-48 bg-gradient-to-br from-gray-900 to-gray-800 rounded-full shadow-2xl flex items-center justify-center border-8 border-white cursor-pointer hover:scale-105 transition-transform duration-300 relative overflow-hidden">
              ...
              <div className="text-center relative z-10">
                ...
                <div className="text-base font-bold text-white mb-1">Strategic Hub</div>
                <div className="text-xs font-semibold text-gray-300 uppercase tracking-wider">Execution Engine</div>
              </div>
            </div>
          </motion.div>
